...
export default {
  ...
  checkUsernameOrEmail(username, email) {
    return ajax('user/check', 'post', {data: {username, email}})
  },
  getUserInfo() {
  ...
  getProblemList(offset, limit, query) {
    ...
    //     }
    // });
    return ajax('/problem/get', 'get', {params: params})
  },
  ...
  doSubmitSolution(id, code) {
    let data = {id, code};
    return ajax('/solution/add', 'post', {data: data})
  },
  getStandardWavedrom(id) {
    let params = {id};
    return ajax('/problem/get_wavedrom', 'get', {params: params})
  },
  getSolutions(id) {
    let params = {id};
    return ajax('/solution/get', 'get', {params: params})
  },
  getSolutionInfo(id) {
    let params = {id};
    return ajax('/solution/get_info', 'get', {params: params});
  }
}
